...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/loguru-cpp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/loguru-cpp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install loguru-cpp
```
...
It is possible to list all of the versions of `loguru-cpp` available on your platform:
...
```
pixi search loguru-cpp --channel conda-forge
```
